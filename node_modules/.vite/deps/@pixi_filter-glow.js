...
// node_modules/@pixi/filter-glow/dist/filter-glow.esm.js
init_core();
init_utils();
...
var GlowFilter = function(_super) {
  ...
  function GlowFilter2(options) {
    ...
    _this = _super.call(this, vertex, fragment.replace(/__ANGLE_STEP_SIZE__/gi, "" + (1 / quality / distance).toFixed(7)).replace(/__DIST__/gi, distance.toFixed(0) + ".0")) || this;
