...
// node_modules/@inlet/react-pixi/dist/react-pixi.es-dev.js
var react_pixi_es_dev_exports = {};
__export(react_pixi_es_dev_exports, {
...
function applyDefaultProps(instance, oldProps, newProps) {
  var changed = false;
  invariant(DisplayObject.prototype.isPrototypeOf(instance), "instance needs to be typeof `PIXI.DisplayObject`, got `%s`", _typeof(instance));
...
function render(element, container) {
  ...
  PixiFiber.updateContainer(element, root, void 0, callback);
  return PixiFiber.getPublicRootInstance(root);
}
function unmountComponentAtNode(container) {
  if (roots.has(container)) {
    PixiFiber.updateContainer(null, roots.get(container), void 0, function() {
...
var import_react, lodash_isnil, eventHandlers, isFunction, isObject, hasKey, not, _PROPS_RESERVED, CHILDREN, PROPS_RESERVED, PROPS_DISPLAY_OBJECT, getTextureFromProps, filterProps, BitmapText$1, Container$1, _excluded$7, Graphics$1, _excluded$6, NineSlicePlane$1, ParticleContainer$1, _excluded$5, Sprite$1, _excluded$4, AnimatedSprite$1, Text$1, _excluded$3, TilingSprite$1, _excluded$2, SimpleMesh$1, _excluded$1, SimpleRope$1, components, TYPES, ELEMENTS, TYPES_INJECTED, commonjsGlobal, getOwnPropertySymbols, hasOwnProperty, propIsEnumerable, objectAssign, scheduler_production_min, scheduler_development, scheduler, schedulerTracing_development, tracing, reactReconciler_development, reactReconciler, name, version$1, description, main, module, author, license, scripts, repository, files, typings, devDependencies, peerDependencies, jest$1, resolutions, dependencies, pkg, global$1, cachedSetTimeout, cachedClearTimeout, queue, draining, currentQueue, queueIndex, title, platform, browser, env, argv, version, versions, release, config, on, addListener, once, off, removeListener, removeAllListeners, emit, performance$1, performanceNow$1, startTime, process2, performanceNow, NO_CONTEXT, prepareChanged, HostConfig, PixiFiber, REACT_DOM_VERSION, PACKAGE_NAME, roots, reactIs_development, reactIs, ReactPropTypesSecret$1, ReactPropTypesSecret_1, printWarning$1, ReactPropTypesSecret, loggedTypeFailures, has$1, checkPropTypes_1, has, printWarning, factoryWithTypeCheckers, propTypes$1, Context, AppProvider, AppConsumer, withPixiApp, noop, propTypes, defaultProps, Stage, _excluded, withFilters, BitmapText3, Container3, Graphics3, NineSlicePlane3, ParticleContainer3, Sprite3, AnimatedSprite3, Text3, TilingSprite3, SimpleMesh3, SimpleRope3;
var init_react_pixi_es_dev = __esm({
  "node_modules/@inlet/react-pixi/dist/react-pixi.es-dev.js"() {
    init_pixi();
    ...
    scheduler_production_min = createCommonjsModule(function(module2, exports) {
      var f, g, h, k;
    ...
    scheduler_development = createCommonjsModule(function(module2, exports) {
      {
        (function() {
    ...
    scheduler = createCommonjsModule(function(module2) {
      {
    ...
    createCommonjsModule(function(module2) {
      module2.exports = function $$$reconciler($$$hostConfig) {
        var exports = {};
        var aa = objectAssign, ba = import_react.default, m = scheduler;
        function q(a) {
        ...
        function Ef(a, b, c) {
          ...
          f !== null && typeof f.componentDidCatch === "function" && (c.callback = function() {
            typeof d !== "function" && (Ff === null ? Ff = /* @__PURE__ */ new Set([this]) : Ff.add(this), zf(a, b));
            var c2 = b.stack;
        ...
        function ud(a, b, c) {
          ...
          a === R && (tf |= b, T === 4 && uf(a, U));
          var d = Nc();
          b === 1 ? (V & 8) !== 0 && (V & 48) === 0 ? Og(a) : (Z(a, c), V === 0 && (zg(), H())) : ((V & 4) === 0 || d !== 98 && d !== 99 || (Fg === null ? Fg = /* @__PURE__ */ new Set([a]) : Fg.add(a)), Z(a, c));
          yg = a;
        }
        function Ng(a, b) {
          a.lanes |= b;
                ...
                if (k !== null && typeof k === "object" && typeof k.then === "function") {
                  ...
                  do {
                    ...
                    if (y) {
                      ...
                      h = b;
                      var Oa = f.pingCache;
                      Oa === null ? (Oa = f.pingCache = new Af(), k = /* @__PURE__ */ new Set(), Oa.set(l, k)) : (k = Oa.get(l), k === void 0 && (k = /* @__PURE__ */ new Set(), Oa.set(l, k)));
                      if (!k.has(h)) {
                        k.add(h);
    ...
    schedulerTracing_development = createCommonjsModule(function(module2, exports) {
      {
        (function() {
    ...
    tracing = createCommonjsModule(function(module2) {
      {
        module2.exports = schedulerTracing_development;
      }
    });
    reactReconciler_development = createCommonjsModule(function(module2) {
      {
        module2.exports = function $$$reconciler($$$hostConfig) {
          var exports = {};
          ...
          var makeOpaqueHydratingObject2 = $$$hostConfig.makeOpaqueHydratingObject;
          $$$hostConfig.makeClientId;
          var makeClientIdInDEV2 = $$$hostConfig.makeClientIdInDEV;
          ...
          function getMaskedContext(workInProgress2, unmaskedContext) {
            {
              ...
              }
              {
                ...
                checkPropTypes2(contextTypes, context, "context", name2);
              }
              if (instance) {
          ...
          function processChildContext(fiber, type, parentContext) {
            {
              ...
              {
                var name2 = getComponentName(type) || "Unknown";
                checkPropTypes2(childContextTypes, childContext, "child context", name2);
              }
          ...
          function popHydrationState(fiber) {
            ...
            var type = fiber.type;
            if (fiber.tag !== HostComponent || type !== "head" && type !== "body" && !shouldSetTextContent2(type, fiber.memoizedProps)) {
              var nextInstance = nextHydratableInstance;
              while (nextInstance) {
          ...
          function setWorkInProgressVersion(mutableSource, version2) {
            if (isPrimaryRenderer) {
              ...
              mutableSource._workInProgressVersionSecondary = version2;
            }
            workInProgressSources.push(mutableSource);
          }
          ...
          function mountOpaqueIdentifier() {
            var makeId = makeClientIdInDEV2.bind(null, warnOnOpaqueIdentifierAccessInDEV.bind(null, currentlyRenderingFiber$1));
            if (getIsHydrating()) {
              ...
              var id = makeOpaqueHydratingObject2(readValue);
            ...
            while (true) {
              ...
              if (node.tag === HostComponent || node.tag === HostText) {
                ...
                if (currentParentIsContainer) {
                  removeChildFromContainer2(currentParent, node.stateNode);
                } else {
            ...
            switch (finishedWork.tag) {
              ...
              case HostComponent: {
                ...
                if (instance != null) {
                  ...
                  if (updatePayload !== null) {
                    commitUpdate2(instance, updatePayload, type, oldProps, newProps, finishedWork);
                  }
                }
                return;
              }
          ...
          function commitResetTextContent(current2) {
            ...
            resetTextContent2(current2.stateNode);
          }
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
    ...
    reactReconciler = createCommonjsModule(function(module2) {
      {
        module2.exports = reactReconciler_development;
      }
    });
    ...
    performanceNow = createCommonjsModule(function(module2) {
      (function() {
        ...
        } else if (typeof process2 !== "undefined" && process2 !== null && process2.hrtime) {
          module2.exports = function() {
            return (getNanoSeconds() - nodeLoadTime) / 1e6;
          };
          hrtime2 = process2.hrtime;
    ...
    PixiFiber = reactReconciler(HostConfig);
    REACT_DOM_VERSION = pkg.devDependencies["react-dom"].replace(/[^0-9.]/g, "");
    ...
    reactIs_development = createCommonjsModule(function(module2, exports) {
      {
        (function() {
    ...
    propTypes$1 = createCommonjsModule(function(module2) {
      {
        var ReactIs = reactIs;
...
var require_module = __commonJS({
  "node_modules/@inlet/react-pixi/module.js"(exports, module2) {
    if (true) {
      module2.exports = (init_react_pixi_es_dev(), __toCommonJS(react_pixi_es_dev_exports));
    } else {
...
// dep:@inlet_react-pixi
var inlet_react_pixi_default = require_module();
export {
  inlet_react_pixi_default as default
};
/*
object-assign
(c) Sindre Sorhus
 ...
 */
//# sourceMappingURL=@inlet_react-pixi.js.map
